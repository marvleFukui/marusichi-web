    ...
    <div class="cf-row">
      ...
      <div class="cf-field">
        <div class="cf-privacy">
          ...
          <h4>個人情報の開示、訂正、削除</h4>
          <p>当社が管理する個人情報に関して、開示・訂正（追加）・削除をご希望される場合には、お申し出いただいたご本人または、ご本人が認めた代理人であることを確認した上で、合理的な範囲内で対応いたします。ただし、第三者の利益を害する恐れのある場合、または当社の業務に著しく支障をきたすと判断した場合は、この限りではありません。</p>
          <h4>個人情報保護方針の改善</h4>
